...
`},tt=e=>{const t=`
    ...
    `;return a("Property",t)+a("Advanced",f(e))},nt=e=>{var t;p(["handle","src","alt","width","height"],e),(t=document.getElementById("setting-alignment"))==null||t.addEventListener("change",n=>e("alignment",n.target.value)),b(),u(e)},ct={config:Qe,validate:Ze,render:et,renderSettings:tt,initSettings:nt},it={defaultData:{handle:"paragraph",text:"This is a paragraph of text.",alignment:"start"}},st=e=>!!e.handle,at=e=>`
        <div class="cfb:flex cfb:justify-between cfb:items-start">
...
`,Yt=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},Gt=(e,t)=>{p(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},Xt={config:Jt,validate:Kt,render:Wt,renderSettings:Yt,initSettings:Gt},Qt={defaultData:{handle:"",label:"",checkboxLabel:"",desc:"",required:!1}},Zt=e=>!(!e.handle||!e.label),en=(e,t)=>`
