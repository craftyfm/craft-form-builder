var J=Object.defineProperty;var Y=(e,t,n)=>t in e?J(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var L=(e,t,n)=>Y(e,typeof t!="symbol"?t+"":t,n);const K=e=>JSON.parse(JSON.stringify(e)),a=(e,t,n=!1)=>`
        <div class="cfb:mb-7">
...
`,v=e=>{var t;(t=document.getElementById("setting-required"))==null||t.addEventListener("change",n=>e("required",n.target.checked))},W=()=>`
...
`,y=e=>{const t=e.required??!1;return`
    ...
    `),M=(e,t)=>[...e.querySelectorAll(".form-field-wrapper")].reduce((s,c)=>{const i=c.getBoundingClientRect(),r=t-i.top-i.height/2;return r<0&&r>s.offset?{offset:r,element:c}:s},{offset:Number.NEGATIVE_INFINITY}).element,G=()=>{const e=document.createElement("div");e.className="cfb:relative cfb:my-4";const t=document.createElement("div");t.className="cfb:absolute cfb:inset-0 cfb:flex cfb:items-center";const n=document.createElement("div");n.className="cfb:w-full cfb:border-t cfb:border-blue-500",t.appendChild(n);const s=document.createElement("div");s.className="cfb:relative cfb:flex cfb:justify-center";const c=document.createElement("span");return c.className="cfb:bg-white cfb:px-3 cfb:text-sm cfb:text-blue-500 cfb:font-medium",c.textContent="Drop here",s.appendChild(c),e.appendChild(t),e.appendChild(s),e},T=e=>{var t;(t=document.getElementById("setting-options"))==null||t.addEventListener("input",n=>{const s=n.target.value.split(`
`).filter(c=>c.trim()!=="").map(c=>({name:c.trim(),value:c.trim(),isDefault:!1}));e("options",s)})},X=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),$=e=>`
    <div>
...
`,ne=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`<div>
        ...
        </div>`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},ce=(e,t)=>{g(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},se={config:Z,validate:ee,render:te,renderSettings:ne,initSettings:ce},ie={defaultData:{handle:"",label:"",placeholder:"Enter your message...",desc:"",rows:4,required:!1,minlength:0,maxlength:0}},ae=e=>!(!e.handle||!e.label),re=(e,t)=>`
     <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
        ${y(e)}
        <div class="${t==="horizontal"?"cfb:w-3/4":""}">
...
`,le=e=>{const t=`
    ...
    `;return a("Property",t)+a("Validation",n)+a("Advanced",f(e))},oe=e=>{var t,n,s;g(["desc","placeholder"],e),(t=document.getElementById("setting-rows"))==null||t.addEventListener("input",c=>e("rows",parseInt(c.target.value,10))),v(e),(n=document.getElementById("setting-minlength"))==null||n.addEventListener("input",c=>e("minlength",parseInt(c.target.value,10))),(s=document.getElementById("setting-maxlength"))==null||s.addEventListener("input",c=>e("maxlength",parseInt(c.target.value,10))),b(),u(e)},de={config:ie,validate:ae,render:re,renderSettings:le,initSettings:oe},be={defaultData:{handle:"",label:"",desc:"",placeholder:"Choose an option...",options:[{name:"Option 1",value:"Option 1",isDefault:!1},{name:"Option 2",value:"Option 2",isDefault:!1}],required:!1}},fe=e=>!(!e.handle||!e.label),ue=(e,t)=>{const n=e.options.map(s=>`<option value="${s.value}">${s.name}</option>`).join("");return`
         <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
...
`)}</textarea>
    ...
    `;return a("Property",t)+a("Validation",h(e))+a("Advanced",f(e))},Ce=e=>{g(["desc"],e),T(e),v(e),b(),u(e)},Ie={config:we,validate:Ee,render:Le,renderSettings:ke,initSettings:Ce},Be={defaultData:{handle:"",label:"",desc:"",allowedExtensions:"",limit:1,required:!1,maxSize:0}},Te=e=>!(!e.handle||!e.label),Me=(e,t)=>`
    <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
        ${y(e)}
        <div class="${t==="horizontal"?"cfb:w-3/4":""}">
            <div class="">
...
`,Ae=e=>{const t=`
    ...
    `;return a("Property",t)+a("Validation",n)+a("Advanced",f(e))},Ne=e=>{var t;g(["allowedExtensions","limit","desc"],e),v(e),(t=document.getElementById("setting-maxSize"))==null||t.addEventListener("input",n=>e("maxSize",n.target.value)),b(),u(e)},qe={config:Be,validate:Te,render:Me,renderSettings:Ae,initSettings:Ne},Pe={defaultData:{handle:"submit",submitText:"Submit",resetText:"Reset",submitStyle:"primary",resetStyle:"secondary",spacing:"wide"}},je=e=>!!e.handle,He=(e,t)=>{const n=e.submitStyle==="primary"?"cfb:bg-blue-600 cfb:text-white":"cfb:bg-gray-600 cfb:text-white",s=e.resetStyle==="primary"?"cfb:bg-blue-600 cfb:text-white":e.resetStyle==="secondary"?"cfb:bg-gray-500 cfb:text-white":"cfb:bg-red-500 cfb:text-white";return`
        <div>
    ...
    `;return a("Property",t)+a("Advanced",f(e))},_e=e=>{var t,n,s;(t=document.getElementById("setting-text"))==null||t.addEventListener("input",c=>e("text",c.target.value)),(n=document.getElementById("setting-level"))==null||n.addEventListener("change",c=>e("level",c.target.value)),(s=document.getElementById("setting-alignment"))==null||s.addEventListener("change",c=>e("alignment",c.target.value)),b(),u(e)},Je={config:De,validate:Ve,render:Re,renderSettings:Ue,initSettings:_e},Ye={defaultData:{handle:"image",src:"",alt:"",width:null,height:null,alignment:"start"}},Ke=e=>!!e.handle,We=(e,t)=>{const n=e.width?`${e.width}px`:"auto",s=e.height?`${e.height}px`:"auto",c=e.width?`width="${e.width}"`:"",i=e.height?`height="${e.height}"`:"";return`
...
`},Ge=e=>{const t=`
    ...
    `;return a("Property",t)+a("Advanced",f(e))},Xe=e=>{var t;g(["handle","src","alt","width","height"],e),(t=document.getElementById("setting-alignment"))==null||t.addEventListener("change",n=>e("alignment",n.target.value)),b(),u(e)},Qe={config:Ye,validate:Ke,render:We,renderSettings:Ge,initSettings:Xe},Ze={defaultData:{handle:"paragraph",text:"This is a paragraph of text. You can edit it in the settings panel.",alignment:"start"}},et=e=>!!e.handle,tt=e=>`
        <div class="cfb:flex cfb:justify-between cfb:items-start">
    ...
    `;return a("Property",t)+a("Advanced",f(e))},ct=e=>{var t;g(["text"],e),(t=document.getElementById("setting-alignment"))==null||t.addEventListener("change",n=>e("alignment",n.target.value)),b(),u(e)},st={config:Ze,validate:et,render:tt,renderSettings:nt,initSettings:ct},it={defaultData:{html:"",handle:"html"}},at=e=>!!e.handle,rt=e=>`
    <div class="cfb:flex cfb:justify-between cfb:items-start">
...
`,lt=e=>{const t=`
    ...
    `;return a("Property",t)+a("Advanced",f(e))},ot=e=>{g(["html"],e),b(),u(e)},dt={config:it,validate:at,render:rt,renderSettings:lt,initSettings:ot},bt={defaultData:{handle:"hcaptcha",siteKey:"",privateKey:"",required:!0}},ft=e=>!0,ut=e=>`
    <div>
        <div class="cfb:flex cfb:justify-between cfb:items-center cfb:mb-3">
...
`,mt=e=>a("Advanced",f(e)),gt=e=>{b(),u(e)},pt={config:bt,validate:ft,render:ut,renderSettings:mt,initSettings:gt},ht={defaultData:{handle:"recaptcha"}},vt=e=>!!e.handle,yt=(e,t)=>`
    <div>
...
`,xt=e=>a("Advanced",f(e)),$t=e=>{b(),u(e)},St={config:ht,validate:vt,render:yt,renderSettings:xt,initSettings:$t},wt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter email...",icon:"",iconSvg:null,required:!1}},Et=e=>!(!e.handle||!e.label),Lt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,kt=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},Ct=(e,t)=>{g(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},It={config:wt,validate:Et,render:Lt,renderSettings:kt,initSettings:Ct},Bt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter url...",icon:"",iconSvg:null,required:!1}},Tt=e=>!(!e.handle||!e.label),Mt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,At=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},Nt=(e,t)=>{g(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},qt={config:Bt,validate:Tt,render:Mt,renderSettings:At,initSettings:Nt},Pt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter phone number...",icon:"",iconSvg:null,required:!1}},jt=e=>!(!e.handle||!e.label),Ht=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,Ft=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},zt=(e,t)=>{g(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},Ot={config:Pt,validate:jt,render:Ht,renderSettings:Ft,initSettings:zt},Dt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter number...",icon:"",iconSvg:null,required:!1}},Vt=e=>!(!e.handle||!e.label),Rt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,Ut=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",f(e))},_t=(e,t)=>{g(["desc","placeholder"],e),v(e),b(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},Jt={config:Dt,validate:Vt,render:Rt,renderSettings:Ut,initSettings:_t},Yt={defaultData:{handle:"",label:"",checkboxLabel:"",desc:"",required:!1}},Kt=e=>!(!e.handle||!e.label),Wt=(e,t)=>`
    ...
    `;return a("Property",t)+a("Validation",h(e))+a("Advanced",f(e))},Xt=(e,t)=>{g(["desc","checkboxLabel"],e),v(e),b(),u(e)},Qt={config:Yt,validate:Kt,render:Wt,renderSettings:Gt,initSettings:Xt},Zt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter Date...",required:!1}},en=e=>!(!e.handle||!e.label),tn=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <input type="date" 
