...
`,le=e=>{const t=`
    ...
    `;return a("Property",t)+a("Validation",n)+a("Advanced",m(e))},oe=e=>{var t,n,s;g(["desc","placeholder"],e),(t=document.getElementById("setting-rows"))==null||t.addEventListener("input",c=>e("rows",parseInt(c.target.value,10))),v(e),(n=document.getElementById("setting-minlength"))==null||n.addEventListener("input",c=>e("minlength",parseInt(c.target.value,10))),(s=document.getElementById("setting-maxlength"))==null||s.addEventListener("input",c=>e("maxlength",parseInt(c.target.value,10))),f(),u(e)},de={config:ie,validate:ae,render:re,renderSettings:le,initSettings:oe},be={defaultData:{handle:"",label:"",desc:"",placeholder:"Choose an option...",options:[{name:"Option 1",value:"Option 1",isDefault:!1},{name:"Option 2",value:"Option 2",isDefault:!1}],required:!1}},fe=e=>!(!e.handle||!e.label),me=(e,t)=>{const n=e.options.map(s=>`<option value="${s.value}">${s.name}</option>`).join("");return`
         <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
...
`)}</textarea>
    ...
    `;return a("Property",t)+a("Validation",h(e))+a("Advanced",m(e))},Ce=e=>{g(["desc"],e),T(e),v(e),f(),u(e)},Ie={config:we,validate:Ee,render:Le,renderSettings:ke,initSettings:Ce},Be={defaultData:{handle:"",label:"",desc:"",allowedExtensions:"",limit:1,required:!1,maxSize:0}},Te=e=>!(!e.handle||!e.label),Me=(e,t)=>`
    <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
        ${y(e)}
        <div class="${t==="horizontal"?"cfb:w-3/4":""}">
            <div class="">
...
`,Ae=e=>{const t=`
    ...
    `;return a("Property",t)+a("Validation",n)+a("Advanced",m(e))},Ne=e=>{var t;g(["allowedExtensions","limit","desc"],e),v(e),(t=document.getElementById("setting-maxSize"))==null||t.addEventListener("input",n=>e("maxSize",n.target.value)),f(),u(e)},qe={config:Be,validate:Te,render:Me,renderSettings:Ae,initSettings:Ne},je={defaultData:{handle:"submit",submitText:"Submit",resetText:"Reset",submitStyle:"primary",resetStyle:"secondary",spacing:"wide"}},Pe=e=>!!e.handle,He=(e,t)=>{const n=e.submitStyle==="primary"?"cfb:bg-blue-600 cfb:text-white":"cfb:bg-gray-600 cfb:text-white",s=e.resetStyle==="primary"?"cfb:bg-blue-600 cfb:text-white":e.resetStyle==="secondary"?"cfb:bg-gray-500 cfb:text-white":"cfb:bg-red-500 cfb:text-white";return`
        <div>
...
`},Ge=e=>{const t=`
    ...
    `;return a("Property",t)+a("Advanced",m(e))},Xe=e=>{var t;g(["handle","src","alt","width","height"],e),(t=document.getElementById("setting-alignment"))==null||t.addEventListener("change",n=>e("alignment",n.target.value)),f(),u(e)},Qe={config:Ye,validate:Ke,render:We,renderSettings:Ge,initSettings:Xe},Ze={defaultData:{handle:"paragraph",text:"This is a paragraph of text. You can edit it in the settings panel.",alignment:"start"}},et=e=>!!e.handle,tt=e=>`
        <div class="cfb:flex cfb:justify-between cfb:items-start">
    ...
    `;return a("Property",t)+a("Advanced",m(e))},ct=e=>{var t;g(["text"],e),(t=document.getElementById("setting-alignment"))==null||t.addEventListener("change",n=>e("alignment",n.target.value)),f(),u(e)},st={config:Ze,validate:et,render:tt,renderSettings:nt,initSettings:ct},it={defaultData:{html:"",handle:"html"}},at=e=>!!e.handle,rt=e=>`
    <div class="cfb:flex cfb:justify-between cfb:items-start">
...
`,lt=e=>{const t=`
    ...
    `;return a("Property",t)+a("Advanced",m(e))},ot=e=>{g(["html"],e),f(),u(e)},dt={config:it,validate:at,render:rt,renderSettings:lt,initSettings:ot},bt={defaultData:{handle:"hcaptcha",siteKey:"",privateKey:"",required:!0}},ft=e=>!0,mt=e=>`
    <div>
        <div class="cfb:flex cfb:justify-between cfb:items-center cfb:mb-3">
...
`,ut=e=>a("Advanced",m(e)),gt=e=>{f(),u(e)},pt={config:bt,validate:ft,render:mt,renderSettings:ut,initSettings:gt},ht={defaultData:{handle:"recaptcha"}},vt=e=>!!e.handle,yt=(e,t)=>`
    <div>
...
`,xt=e=>a("Advanced",m(e)),$t=e=>{f(),u(e)},St={config:ht,validate:vt,render:yt,renderSettings:xt,initSettings:$t},wt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter email...",icon:"",iconSvg:null,required:!1}},Et=e=>!(!e.handle||!e.label),Lt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,At=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",m(e))},Nt=(e,t)=>{g(["desc","placeholder"],e),v(e),f(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},qt={config:Bt,validate:Tt,render:Mt,renderSettings:At,initSettings:Nt},jt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter phone number...",icon:"",iconSvg:null,required:!1}},Pt=e=>!(!e.handle||!e.label),Ht=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,Ft=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",m(e))},zt=(e,t)=>{g(["desc","placeholder"],e),v(e),f(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},Ot={config:jt,validate:Pt,render:Ht,renderSettings:Ft,initSettings:zt},Dt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter number...",icon:"",iconSvg:null,required:!1}},Rt=e=>!(!e.handle||!e.label),Vt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
...
`,Ut=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",m(e))},_t=(e,t)=>{g(["desc","placeholder"],e),v(e),f(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},Jt={config:Dt,validate:Rt,render:Vt,renderSettings:Ut,initSettings:_t},Yt={defaultData:{handle:"",label:"",checkboxLabel:"",desc:"",required:!1}},Kt=e=>!(!e.handle||!e.label),Wt=(e,t)=>`
