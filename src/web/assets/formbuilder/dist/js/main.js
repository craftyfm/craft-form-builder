...
`,Ft=(e,t)=>{let n=`
    ...
    `;return t.settings.icons!==""&&(n+=`${C(e)}`),a("Property",n)+a("Validation",h(e))+a("Advanced",m(e))},Ot=(e,t)=>{g(["desc","placeholder"],e),v(e),f(),t.formState.settings.icons!==""&&t.iconPicker.init("setting-icon",t.formState.settings.icons),u(e)},zt={config:jt,validate:Pt,render:Ht,renderSettings:Ft,initSettings:Ot},Dt={defaultData:{handle:"",label:"",desc:"",placeholder:"Enter number...",icon:"",iconSvg:null,required:!1}},Vt=e=>!(!e.handle||!e.label),Rt=(e,t)=>`
        <div class="cfb:flex ${t==="horizontal"?"cfb:flex-row":"cfb:flex-col"}">
            ${y(e)}
            <div class="${t==="horizontal"?"cfb:w-3/4":""}">
                <div class="cfb:relative cfb:w-full cfb:flex-3">
